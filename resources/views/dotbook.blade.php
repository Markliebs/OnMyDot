...
<div class="container">
    <div class="setList2">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <a href="#" class="list-group-item active" data-toggle="tooltip" data-placement="left" title="Dots for current movement will appear here"
                data-original-title="Dots for current movement will appear here">Dot Book</a>
            <ul class="list-group">
